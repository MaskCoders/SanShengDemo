 ...
 */
public class UIUnrevisableView extends RelativeLayout {
    ...
    public UIUnrevisableView(Context context) {
        this(context, null);
    }

    public UIUnrevisableView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UIUnrevisableView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        li.inflate(R.layout.unchangable_view, this, true);
    }
